...
;
 ...
 //             <Link href="/" className="hove:underline">Home</Link>
 //             <Link href="/about" className="hove:underline">About</Link>
 //             <Link href="/contact" className="hove:underline">Contact</Link>
 //         </div>
 //         <div>
 //             <Link href="/login" className="hove:underline">Login</Link>
 //             <Link href="/register" className="hove:underline">Register</Link>
 //         </div>
 //     </nav>
 //   )
 // }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__94d01d60._.js.map